...
var APP_LANG = {
    "MESSAGES": {
        ...
        "TIMEOUT_UNRECOVERABLE": {
            ...
            "CONTENT": 'Υπάρχει μια καθυστέρηση στη σύνδεση του δικτύου. Παρακαλώ \x3ca href\x3d"#" id\x3d"reloadbtn"\x3eπάτησε εδώ\x3c/a\x3e για ανανέωση της σελίδας.'
        },
        "HTTP_ERROR": {
            400: "Σφάλμα Http: \x3cstrong\x3e400\x3c/strong\x3e",
        ...
        "RESPONSIVE_TABLES_ERROR": 'Για τεχνικούς λόγους ήταν αδύνατον να πραγματοποιήσουμε την ενέργεια που ζήτησες. Παρακαλώ δοκίμασε αργότερα ή \x3ca href\x3d"#" id\x3d"reloadbtn"\x3eπάτησε εδώ\x3c/a\x3e για ανανέωση'
    },
    "STATE_INPUT_PLACEHOLDER": "Ο νομός σου",
    "RESULTS_FOUND": {
        "result_found": "Βρήκαμε \x3cspan\x3e1\x3c/span\x3e αποτέλεσμα",
        "results_found": "Βρήκαμε \x3cspan\x3e%%results%%\x3c/span\x3e αποτελέσματα ",
        "no_results_found": "Βρήκαμε \x3cspan\x3e0\x3c/span\x3e αποτελέσματα"
    },
    "RESP_TABLE_ACTIONS": {
        "actions": "Ενέργειες",
        "edit": "Αλλαγή",
    ...
    "STATUSES": {"active": "ΕΝΕΡΓΟ", "inactive": "ΑΝΕΝΕΡΓΟ", "deleted": "ΔΙΕΓΡΑΜΜΕΝΟ"},
    "TOOLTIPS": {"default_profile_admin": "This is the user`s default profile"},
    "MISC": {
        "ERROR": "Σφάλμα",
        "REMOVE": "Αφαίρεση",
...
var COMMON_LANG = {
    LENGTH: {"MONTH": "μήνα", "MONTHS": "μήνες", "YEAR": "έτος", "YEARS": "έτη"},
    COUNTRIES: {
        "GB": "Αγγλία",
        "AT": "Αυστρία",
        "BE": "Βέλγιο",
    ...
    SIDE_NAV: {
        ...
        "VAT_TEMPLATES": {
            "WITHOUT": {"TEXT": "Τιμές χωρίς ΦΠΑ", "TITLE": "Αφαίρεση ΦΠΑ"},
            "WITH": {"TEXT": "Τιμές με ΦΠΑ", "TITLE": "Προσθήκη ΦΠΑ"}
        },
    ...
    LABEL: {"VERIFIED": "ΕΠΑΛΗΘΕΥΜΕΝΟ", "UNVERIFIED": "ΑΝΕΠΑΛΗΘΕΥΤΟ"},
    CONFIRMS: {
        USER_STATUS: {
    ...
    STATUS: {ENABLE: "Ενεργοποίηση", DISABLE: "Απενεργοποίηση"},
    CONNECTIVITY: {PENDING_RESPONSE: "Σε αναμονή απάντησης"},
    CART: {
        HARDWARE: "Υλικό",
        SOFTWARE: "Λογισμικό",
    ...
    DOMAINS: {
        ...
        WHOIS: {EXTEND: "Επέκταση υπηρεσίας"},
        TRADE: {APPLICATION: {BUTTON: {FORTH: "Προσθήκη στο καλάθι", OTHERS: "Μεταβίβαση domain"}}}
    },
    MISC: {
        TODAY: "Today",
        CANCEL: "Ακύρωση", RETURN: "Επιστροφή"
    },
    RESP_TABLE: {RENEW: "Ανανέωση"}
};
var TRANS = {
    LENGTH: {"MONTH": {1: "μήνα", 2: "μήνες"}, "YEAR": {1: "έτος", 2: "έτη"}},
    BILLING: {
        TYPE: {REC: "Απόδειξη", INV: "Τιμολόγιο"},
        STATUS: {SUCCESS: "ΕΝΕΡΓΟ", ERROR: "ΑΝΕΝΕΡΓΟ"},
        VAT: "ΑΦΜ",
        DOY: "ΔΟΥ",
        FROM: "(από ##price##)"
    },
    CART: {
        DOMAIN_TRANSFER_SUCCESSFUL: {1: "Προστέθηκε στο καλάθι", 2: "Όλα τα domains προστέθηκαν στο καλάθι"},
        ATTRIBUTES: {SSL_INSTALL: {DOMAIN_NAME: "Πρέπει να συμπληρώσεις το Domain name όπου θα γίνει η εγκατάσταση του SSL"}},
        WARNINGS: {HOSTING: '\x3cstrong\x3eΠροσοχή!\x3c/strong\x3e Η παραγγελία αφορά αγορά νέου πακέτου φιλοξενίας. Για ανανέωση ή αναβάθμιση δες \x3ca href\x3d"https://dnhost.gr/kb/article/AA-00718" target\x3d"_blank"\x3eεδώ\x3c/a\x3e.'},
    ...
    DOMAINS: {
        ...
        CONTACT_ROLES: {
            REGISTRANT: {DISPLAY: "Δικαιούχος", FORM: {1: "Δικαιούχο", 2: "Δικαιούχου"}},
            ADMIN: {DISPLAY: "Διαχειριστής", FORM: {1: "Διαχειριστή", 2: "Διαχειριστή"}},
            TECH: {DISPLAY: "Τεχνικός", FORM: {1: "Τεχνικό", 2: "Τεχνικού"}},
            BILLING: {DISPLAY: "Οικονομικά", FORM: {1: "Οικονομικό", 2: "Οικονομικών"}}
        },
        RESPONSIVE_TABLES_PREVIEW: {
            REGISTERED: {1: "ΚΑΤΟΧΥΡΩΜΕΝΟ ΟΝΟΜΑ ΧΩΡΟΥ", 2: "ΚΑΤΟΧΥΡΩΜΕΝΑ ΟΝΟΜΑΤΑ ΧΩΡΟΥ"},
            EXPIRES: {1: "ΛΗΓΕΙ ΣΥΝΤΟΜΑ", 2: "ΛΗΓΟΥΝ ΣΥΝΤΟΜΑ"},
            EXPIRED: {1: "ΕΧΕΙ ΛΗΞΕΙ", 2: "ΕΧΟΥΝ ΛΗΞΕΙ"},
            ID_PROTECT: {TITLE: {ON: "ID Protect ενεργό", NA: "ID Protect not applicable"}}
        },
        INTERNAL_TRANSFER: {
            SINGLE_DOMAIN: "H μεταφορά \x3cstrong\x3e##domain##\x3c/strong\x3e στον χρήστη \x3cstrong\x3e##user##\x3c/strong\x3e ολοκληρώθηκε με επιτυχία.",
            MULTIPLE_DOMAINS: "H μεταφορά domains στον χρήστη \x3cstrong\x3e##user##\x3c/strong\x3e ολοκληρώθηκε με επιτυχία.",
        ...
        SEARCH: {
            FILTERS: {ALL: "Όλα"}, ELNOTIFICATIONS: {
            ...
            BUTTONS: {CHECKING: "Αναζήτηση"}
        },
        WARNINGS: {ELCOPYRIGHT: "Για να κατοχυρώσεις αυτό το .ελ domain στην DNHOST, θα πρέπει το αντίστοιχο .gr domain να βρίσκεται στον λογαριασμό σου στην DNHOST."}
    },
    SSL: {
        BUTTONS: {GET_CERTIFICATE: "Λήψη Πιστοποιητικού", REISSUE: "Επανέκδοση", RENEW: "Ανανέωση", CANCEL: "Ακύρωση"},
        STATUSES: {
            CANCELLED: "Ακυρώθηκε",
            CAPS: {
                ACTIVE: "ΕΝΕΡΓΟ",
        ...
        ORDER_SSL_MODAL: {INITIAL: "Αρχική", DISCOUNT: "Έκπτωση", FINAL: "Τελική"},
        WHYNOPADLOCK: {
    ...
    HOSTING: {
        MAGENTO: {
            SHOWGRAPHS: {
                OPEN: 'Δες τα συγκριτικά γραφήματα \x3ci class\x3d"icon-arrow-down2"\x3e\x3c/i\x3e',
                CLOSE: 'Κλείσε τα συγκριτικά γραφήματα \x3ci class\x3d"icon-arrow-up2"\x3e\x3c/i\x3e'
            }
        },
        CREATE: {
    ...
    DOCUMENTS: {
        ...
        TABS: {
            PAY_DOCUMENTS: {1: "Χρήση πίστωσης (##count##)", 2: "Χρήση πίστωσης (##count##)"},
            PAYMENTS: {
                USED_TO_PAY_DOCUMENT: {
                    1: "Χρησιμοποιήθηκε από (##count##)",
                    2: "Χρησιμοποιήθηκε από (##count##)"
                }, PAID_BY_DOCUMENTS: {1: "Εξοφλήθηκε από (##count##)", 2: "Εξοφλήθηκε από (##count##)"}
            },
            PAY_WITH: {1: "Εξόφληση με (##count##)", 2: "Εξόφληση με (##count##)"},
    ...
    MENU: {
        MAIN: {ADMIN: {DOMAIN_LIST: "Ολα τα domains", HOSTING_LIST: "Ολα τα hosting"}},
        STATIC: {TITLE: "ΜΕΝΟΥ ΠΛΟΗΓΗΣΗΣ"}
    },
    WHOIS: {MODAL: {TITLE: "##domain## - WHOIS DOMAIN"}},
    COUPONS: {
        CREATE: {
            ALL_USERS: "Όλοι",
            STATUS: {ACTIVE: "ΕΝΕΡΓΟ", WARNING: "ΣΕ ΑΝΑΜΟΝΗ"},
            USERS: {
                FILTERS: {
                    REGISTRATION: {NEW: "Τις τελευταιές 30 μέρες", OLD: "Πάνω από 30 μέρες"},
                    ORDERS: {NEVER: "Ποτέ"}
                }
            },
            FROM: "Από",
    ...
    PRICING: {MONTHLY_FEE_TITLE: "Μηνιαίο κόστος", SETUP_FEE: "Κόστος εγκατάστασης"},
    MISC: {
        TABLES: {NO_RESULTS: "Δεν υπάρχουν αποτελέσματα"},
        SETUP_FEE: "Kόστος εγκατάστασης",
        DASHBOARD: "Πίνακας Ελέγχου",
        SIDR_MENU_TITLE: "ΔΙΑΧΕΙΡΙΣΗ ΥΠΗΡΕΣΙΩΝ",
        AMOUNT: "Ποσό",
        PERCENTAGE: "Ποσοστό",
        DATES: {DAYS: "Ημέρες", HOURS: "Ώρες", MINUTES: "Λεπτά", SECONDS: "Δεύτερα"},
...
VALIDATION_MESSAGES = {
    "ERRORS": {
        ...
        "ILLEGAL": {"CHARS": "Η απάντησή σου περιέχει μη αποδεκτούς χαρακτήρες"},
        ...
        "CONTACT_PROFILES": {"MISSING": "Αυτό το πρόσωπο έχει ελλιπή στοιχεία. Παρακαλώ συμπλήρωσέ τα!"},
        ...
        "CUSTOM": {
            "WHOIS": {
                "POSTKEYWORD": {
                    ...
                    "LENGTH": {"MIN": "Ένα domain δε μπορει να είναι μικρότερο από ##n## χαρακτήρες"}
                }
            }
        }
    }
...
$(document).ready(function () {
    ...
    function insert_sale(itemId, data, cart_items) {
        ...
        if ("promo" in data.billing.price && typeof data.billing.price.promo == "number" && data.billing.price.promo != data.billing.price.base) panel.find(".price").addClass("discount").html(promoPrices.replace("##previousPrice##", $.imperial_to_metric(data.billing.price.base)).replace("##newPrice##",
